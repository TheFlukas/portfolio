...
Процедура ЗаполнитьДиаграммы(РезультатОтчета, ДанныеРасшифровкиКомпоновкиДанных)
	...
	ДиаграммаПоITСервисам = РезультатОтчета.Рисунки[2].Объект;
	
	Если ДанныеРасшифровкиПоITСервисам = "" Тогда
		ДанныеРасшифровкиПоITСервисам = ПоместитьВоВременноеХранилище(ДанныеРасшифровкиКомпоновкиДанных, 
																   УникальныйИдентификатор);
	Иначе																		   
	 	ПоместитьВоВременноеХранилище(ДанныеРасшифровкиКомпоновкиДанных, ДанныеРасшифровкиПоITСервисам);
	КонецЕсли;    
КонецПроцедуры
...
КонецПроцедуры  
&НаКлиенте
Процедура ДиаграммаПоITСервисамОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	СтандартнаяОбработка = Ложь;
КонецПроцедуры
