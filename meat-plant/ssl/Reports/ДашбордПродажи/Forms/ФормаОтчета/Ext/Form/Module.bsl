...
Процедура ЗаполнитьДиаграммы(РезультатОтчета, ДанныеРасшифровкиКомпоновкиДанных)
	...
	ДиаграммаПоКлиентам = РезультатОтчета.Рисунки[2].Объект;
	
	Если ДанныеРасшифровкиПоКлиентам = "" Тогда
		ДанныеРасшифровкиПоКлиентам = ПоместитьВоВременноеХранилище(ДанныеРасшифровкиКомпоновкиДанных, 
																   УникальныйИдентификатор);
	Иначе																		   
	 	ПоместитьВоВременноеХранилище(ДанныеРасшифровкиКомпоновкиДанных, ДанныеРасшифровкиПоКлиентам);
	КонецЕсли;
